...
% Linear time graph in eng
plot(x,y, "marker", 'o', "color", 'r', "linestyle", ':');
xlabel("bits"); ylabel("seg");
title("Search time vs Key size");
print -djpg image_eng.jpg

% Log time graph in eng
semilogy(x,y, "marker", 'o', "color", 'r',"linestyle", ':');
xlabel("bits"); ylabel("seg");
title("Search time vs Key size");
print -djpg image_log_eng.jpg
